...
if __name__ == "__main__":
    ...
    root_path = Path.cwd()
    # data load path
    train_data_path = root_path / "artifacts" / "data" / "interim" / "train.csv"
    test_data_path = root_path / "artifacts" /"data" / "interim" / "test.csv"
    # save data directory
    save_data_dir = root_path / "artifacts" / "data" / "processed"
    ...
    transformer_save_dir = root_path / "artifacts" / "models"
